...
MainInfoPlotter.prototype.Draw = function(c) {
    ...
    var D = B.getLanguage();
    if (D == "zh-cn") {
        if (!Plotter.drawString(c, "æ—¶é—´: " + k + "-" + A + "-" + z + "  " + f + ":" + l, a)) {
            return
        }
        if (!Plotter.drawString(c, "  å¼€: " + C.open.toFixed(i), a)) {
            return
        }
        if (!Plotter.drawString(c, "  é«˜: " + C.high.toFixed(i), a)) {
            return
        }
        if (!Plotter.drawString(c, "  ä½Ž: " + C.low.toFixed(i), a)) {
            return
        }
        if (!Plotter.drawString(c, "  æ”¶: " + C.close.toFixed(i), a)) {
            return
        }
    } else {
        if (D == "en-us") {
            ...
            if (D == "zh-tw") {
                ...
                if (!Plotter.drawString(c, "  é–‹: " + C.open.toFixed(i), a)) {
                    return
                }
                if (!Plotter.drawString(c, "  é«˜: " + C.high.toFixed(i), a)) {
                    return
    ...
    if (D == "zh-cn") {
        if (!Plotter.drawString(c, "  æŒ¯å¹…: " + d.toFixed(2) + " %", a)) {
            return
        }
        if (!Plotter.drawString(c, "  é‡: " + C.volume.toFixed(2), a)) {
            return
        }
    } else {
        if (D == "en-us") {
...
function refresh_function() {
    ...
    if (refresh_counter > 3600) {
        ...
        if (b == "en-us") {
            ...
            $("#chart_updated_time_text").html(a.toFixed(0) + "å°æ—¶")
        }
    } else {
        if (refresh_counter > 60 && refresh_counter <= 3600) {
            ...
            if (b == "en-us") {
                ...
                $("#chart_updated_time_text").html(a.toFixed(0) + "åˆ†é’Ÿ")
            }
        } else {
            if (refresh_counter <= 60) {
                if (b == "en-us") {
                    ...
                    $("#chart_updated_time_text").html(refresh_counter + "ç§’")
                }
            }
        }
    }
